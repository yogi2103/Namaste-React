...
//component composition (passing component into another component)
...
//React element
const heading2 = <h1 className="Jhakas">Hello</h1>; //JSX

const list = React.createElement("ul", {}, [
  React.createElement("li", {}, "About us"),
  React.createElement("li", {}, "Support us"),
...
const container = React.createElement(
  ...
  [
    React.createElement("h1", { style: { size: 10 }, key: "hola" }, "Woah"),
    list,
  ]
);

const heading = React.createElement("h1", { style: { size: 10 } }, "Woah");
